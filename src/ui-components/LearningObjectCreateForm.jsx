...
export default function LearningObjectCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new LearningObject(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LearningObjectCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
